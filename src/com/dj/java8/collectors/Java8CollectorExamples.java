package com.dj.java8.collectors;
...
/*
 * Output: [Sundar, Pichai, Larry, Page] [Asia, Africa, North America] [Asia,
 * Africa, hello, North America] [50000.0, 450000.0] [450000.0, 50000.0,
 * 450000.0, 450000.0] [Sundar, Pichai, Larry, Page] [Africa, Asia, North
 * America] {400=Employee [id=400, name=Page, age=59, region=Africa,
 * sal=450000.0], 100=Employee [id=100, name=Sundar, age=47, region=North
 * America, sal=450000.0], 200=Employee [id=200, name=Pichai, age=25,
 * region=North America, sal=50000.0], 300=Employee [id=300, name=Larry, age=30,
 * region=Asia, sal=450000.0]} {400=Employee [id=400, name=Page, age=59,
 * region=Africa, sal=450000.0], 100=Employee [id=100, name=Sundar, age=47,
 * region=North America, sal=450000.0], 200=Employee [id=200, name=Pichai,
 * age=25, region=North America, sal=50000.0], 300=Employee [id=300, name=Larry,
 * age=30, region=Asia, sal=450000.0]} {400=Employee [id=400, name=Page, age=59,
 * region=Africa, sal=450000.0], 100=Employee [id=100, name=Sundar, age=47,
 * region=North America, sal=450000.0], 200=Employee [id=200, name=Pichai,
 * age=25, region=North America, sal=50000.0], 300=Employee [id=300, name=Larry,
 * age=30, region=Asia, sal=450000.0]} Collectors.summingInt : 1000
 * Collectors.summingDouble : 1400000.0 Collectors.averagingDouble avg sal:
 * 350000.0 Collectors.counting() : Count : 4 joinedStr by using joining()
 * method : SundarPichaiLarryPage joinedDelimiterStr by using joining(Delimiter)
 * method : Sundar * Pichai * Larry * Page joinePrePostStr by using
 * joining(Delimiter) method : @Sundar*Pichai*Larry*Page| groupByRegion ::
 * {Asia=[Employee [id=300, name=Larry, age=30, region=Asia, sal=450000.0]],
 * Africa=[Employee [id=400, name=Page, age=59, region=Africa, sal=450000.0]],
 * North America=[Employee [id=100, name=Sundar, age=47, region=North America,
 * sal=450000.0], Employee [id=200, name=Pichai, age=25, region=North America,
 * sal=50000.0]]} groupByRegionSet :: {Asia=[Employee [id=300, name=Larry,
 * age=30, region=Asia, sal=450000.0]], Africa=[Employee [id=400, name=Page,
 * age=59, region=Africa, sal=450000.0]], North America=[Employee [id=100,
 * name=Sundar, age=47, region=North America, sal=450000.0], Employee [id=200,
 * name=Pichai, age=25, region=North America, sal=50000.0]]} partitionByAge ::
 * {false=[Employee [id=200, name=Pichai, age=25, region=North America,
 * sal=50000.0], Employee [id=300, name=Larry, age=30, region=Asia,
 * sal=450000.0]], true=[Employee [id=100, name=Sundar, age=47, region=North
 * America, sal=450000.0], Employee [id=400, name=Page, age=59, region=Africa,
 * sal=450000.0]]} {400=Employee [id=400, name=Page, age=59, region=Africa,
 * sal=450000.0], 100=Employee [id=100, name=Sundar, age=47, region=North
 * America, sal=450000.0], 200=Employee [id=200, name=Pichai, age=25,
 * region=North America, sal=50000.0], 300=Employee [id=300, name=Larry, age=30,
 * region=Asia, sal=450000.0]} {400=Employee [id=400, name=Page, age=59,
 ...
 * region=North America, sal=450000.0], 200=Employee [id=200, name=Pichai,
 * age=25, region=North America, sal=50000.0], 300=Employee [id=300, name=Larry,
 * age=30, region=Asia, sal=450000.0]} Collectors.filtering() - filteredEmpList
 * : [Employee [id=100, name=Sundar, age=47, region=North America,
 * sal=450000.0], Employee [id=400, name=Page, age=59, region=Africa,
 * sal=450000.0]] itemsByGender : {F=[LineItem [itemId=2001, itemName=Item 6,
 * manfacturedDate=Mon Aug 01 00:00:00 IST 3910], LineItem [itemId=2002,
 * itemName=Item 7, manfacturedDate=Sun Aug 01 00:00:00 IST 3920]], M=[LineItem
 * [itemId=1001, itemName=Item 1, manfacturedDate=Mon Aug 01 00:00:00 IST 3910],
 * LineItem [itemId=1005, itemName=Item 5, manfacturedDate=Tue Aug 01 00:00:00
 * IST 3950], LineItem [itemId=1004, itemName=Item 4, manfacturedDate=Thu Aug 01
 * 00:00:00 IST 3940], LineItem [itemId=1002, itemName=Item 2,
 * manfacturedDate=Sun Aug 01 00:00:00 IST 3920], LineItem [itemId=1003,
 * itemName=Item 3, manfacturedDate=Fri Aug 01 00:00:00 IST 3930], LineItem
 * [itemId=2003, itemName=Item 8, manfacturedDate=Thu Aug 01 00:00:00 IST 3940],
 * LineItem [itemId=3004, itemName=Item 9, manfacturedDate=Sat Aug 01 00:00:00
 * IST 3970], LineItem [itemId=3005, itemName=Item 10, manfacturedDate=Sun Aug
 * 01 00:00:00 IST 4100]]} itemsCountByGender {F=2, M=8} Max Emp : Employee
 * [id=400, name=Page, age=59, region=Africa, sal=450000.0] Min Emp : Employee
 * [id=100, name=Sundar, age=47, region=North America, sal=450000.0] Min Emp
 * using reducing() method : Employee [id=100, name=Sundar, age=47, region=North
 * America, sal=450000.0] Statistics summary on employees salary :
 * DoubleSummaryStatistics{count=4, sum=1400000.000000, min=50000.000000,
 * average=350000.000000, max=450000.000000} Average of first 100 numbers: 50.0
 * 
 */